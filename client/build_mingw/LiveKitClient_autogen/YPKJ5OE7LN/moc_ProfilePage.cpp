...
QT_MOC_LITERAL(1, 12, 10), // "SIG_logout"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 16) // "SIG_openSettings"

    },
    "ProfilePage\0SIG_logout\0\0SIG_openSettings"
};
...
void ProfilePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->SIG_openSettings(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProfilePage::SIG_logout)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ProfilePage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProfilePage::SIG_openSettings)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ProfilePage::SIG_logout()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ProfilePage::SIG_openSettings()
{
