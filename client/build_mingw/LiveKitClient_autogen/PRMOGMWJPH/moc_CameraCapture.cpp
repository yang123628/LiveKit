...
#include "../../../src/core/CameraCapture.h"
...
QT_MOC_LITERAL(3, 34, 5) // "frame"
    ...
    "CameraCapture\0SIG_sendVideoFrame\0\0"
    "frame"
};
...
void CameraCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CameraCapture::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraCapture::SIG_sendVideoFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraCapture::SIG_sendVideoFrame(QImage _t1)
{
