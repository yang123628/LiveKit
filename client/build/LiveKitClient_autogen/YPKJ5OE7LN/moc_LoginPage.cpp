...
QT_MOC_LITERAL(3, 24, 16) // "switchToRegister"

    },
    "LoginPage\0loginSuccess\0\0switchToRegister"
};
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (LoginPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginPage::switchToRegister)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void LoginPage::switchToRegister()
{
