...
QT_MOC_LITERAL(3, 30, 13) // "switchToLogin"
    ...
    "RegisterPage\0registerSuccess\0\0"
    "switchToLogin"
};
...
void RegisterPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterPage::registerSuccess)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RegisterPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterPage::switchToLogin)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void RegisterPage::switchToLogin()
{
